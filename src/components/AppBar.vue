<template>
  <div>
      <v-app-bar dark elevation="1" fixed app dense >
    ...
    <v-navigation-drawer v-model="drawer" fixed temporary dark>
      ...
      <v-list>
        ...
        <v-list-item router-link to="/profile" v-if="isLogin && getIsApplicant">
          <v-list-item-content>
            <v-list-item-title >Profile</v-list-item-title>
          </v-list-item-content>
        </v-list-item>

        <v-list-item router-link to="/company-profile" v-if="isLogin && getIsCompany">
          <v-list-item-content>
            <v-list-item-title >Company Profile</v-list-item-title>
          </v-list-item-content>
        </v-list-item>

        <v-list-item router-link to="/post-job" v-if="isLogin && getIsCompany">
          <v-list-item-content>
        ...
        <v-list-item router-link to="/login" v-if="!isLogin">
          <v-list-item-content>
            <v-list-item-title >Log in</v-list-item-title>
          </v-list-item-content>
        </v-list-item>

        <v-list-item router-link to="/sign-up" v-if="!isLogin">
          <v-list-item-content>
            <v-list-item-title >Sign Up</v-list-item-title>
          </v-list-item-content>
        </v-list-item>

        <v-list-item v-if="isLogin" @click.prevent="logout">
          <v-list-item-content>
